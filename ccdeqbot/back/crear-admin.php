...
<head>
    ...
    <title>Crear superadministrador | CCdeQbot CRM</title>
    <style>
        *{box-sizing:border-box}body{margin:0;font-family:Arial,sans-serif;background:#f2f6ef;color:#263322;display:grid;min-height:100vh;place-items:center;padding:24px}.card{width:min(520px,100%);background:#fff;border-radius:18px;padding:32px;box-shadow:0 18px 60px rgba(39,67,29,.14);border-top:6px solid #507b38}h1{margin:0 0 8px;color:#507b38}p{line-height:1.5}.field{margin:14px 0}label{display:block;font-weight:700;margin-bottom:6px}input{width:100%;padding:12px 14px;border:1px solid #cfdbca;border-radius:10px;font:inherit}button{width:100%;border:0;border-radius:10px;padding:13px;background:#507b38;color:#fff;font-weight:700;cursor:pointer}.alert{padding:12px 14px;border-radius:10px;margin:16px 0}.ok{background:#edf7e8;color:#315c20}.error{background:#fff0ef;color:#9b2c24}.small{font-size:13px;color:#64705f}
    </style>
</head>
<body>
<main class="card">
